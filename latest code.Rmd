...
pacman::p_load(DHARMa, lme4, rptR, ggplot2, dplyr, readr, tidyverse, patchwork, epitools, cowplot)

data <- read_csv("clean_data.csv") #all data 
zoop <- read_csv("zoop.csv") #microfauna analysis summary
temp_summary <- read_csv("temp_summary.csv") #ibutton data 
